...
推荐方式是使用`go mod`，通过在源码中`import github.com/haogooder/gospanner/mongo` 来自动安装依赖。

当然，通过下面方式同样可行：

```
go get github.com/haogooder/gospanner/mongo
```
...
- 开始
    ...
    import(
        ...
        "github.com/haogooder/gospanner/mongo"
    )
...
- 事务
    ...
    [关于事务的更多内容](https://github.com/haogooder/gospanner/mongo/wiki/Transactions)
...
- Hooks
    ...
    [Hooks 详情介绍](<https://github.com/haogooder/gospanner/mongo/wiki/Hooks--(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87)>)
...
- 自动化更新fields
    ...
    [例子介绍](https://github.com/haogooder/gospanner/mongo/blob/master/field_test.go)

    [自动化 fields 详情介绍](https://github.com/haogooder/gospanner/mongo/wiki/Automatically-update-fields)
